...
namespace Utilities.Math
{
    ...
    {
        public static double OctavePerlin(Vector3 values, int octaves, double persistence, Vector3 frequency, double amplitude = 1)
        {
            return OctavePerlin(values.x, values.y, values.z, octaves, persistence, frequency, amplitude);
        }
        
        public static double OctavePerlin(double x, double y, double z, int octaves, double persistence, Vector3 frequency, double amplitude = 1)
        {
            double total = 0;
            for (int i = 0; i < octaves; i++) {
                total += perlin(x * frequency.x, y * frequency.y, z * frequency.z) * amplitude;
