...
namespace ECM.Controllers
{
    ...
    public class BaseFirstPersonController : BaseCharacterController, IPortalTraveller
    {
        ...
        #region PROPERTIES
        private bool jumpPressed => InputController.Instance.IsPressed(InputPatterns.Jump);
        private Vector2 move => InputController.Instance.GetValue<Vector2>(InputPatterns.Movement);
