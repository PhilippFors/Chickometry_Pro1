...
namespace ECM2.Characters
{
    ...
    public class Character : MonoBehaviour, ICharacterMovementCallbacks
    {
        ...
        {
            get => _jumpImpulse / jumpMultiplier;
        ...
        protected virtual Vector2 GetMovementInput()
        {
            ...
            return InputController.Instance.GetValue<Vector2>(InputPatterns.Movement);
            // return Vector2.zero;
        }
        ...
        protected virtual void SetupPlayerInput()
        {
            ...
            var action = InputController.Instance.Get(InputPatterns.Jump);
