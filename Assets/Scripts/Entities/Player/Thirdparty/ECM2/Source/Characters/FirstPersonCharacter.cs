...
namespace ECM2.Characters
{
    ...
    public class FirstPersonCharacter : Character, IService, IPortalTraveller
    {
        ...
        protected virtual Vector2 GetMouseLookInput()
        {
            ...
            return InputController.Instance.GetValue<Vector2>(InputPatterns.MouseDelta);
            // return Vector2.zero;
        }
        ...
        protected override void SetupPlayerInput()
        {
            ...
            // InputController.Instance.Get(InputPatterns.P).Started += OnCursorLock;
        ...
        protected override void HandleInput()
        {
            ...
            if (actions == null || IsDisabled() || !enableLook)
                return;
