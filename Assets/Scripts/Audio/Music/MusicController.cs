...
namespace Audio.Music
{
    public class MusicController : MonoBehaviourService
    {
        ...
        [SerializeField, DisableIf("loopAll")]
        private bool doCustomLoop;
        [SerializeField]
        private bool useCustomLoopTime;
